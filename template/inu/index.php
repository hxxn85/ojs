...
<body>
	<div class="container" style="background-color:#e56d63; max-width:100%">
		<?php include("template/$OJ_TEMPLATE/nav.php");?>
		<!-- Main component for a primary marketing message or call to action -->
        <div style="max-width:100%"> <center><img src="template/inu/images/ac.png"> </center></div>
		<div style="background-color:#e56d63">
			<?php echo $view_news?>
		</div>
	</div>
	<!-- /container -->
