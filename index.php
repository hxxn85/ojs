...
. "LIMIT 50";
$view_news .= "<div class='panel panel-default' style='width:100%;margin:0 auto; background-color:#e56d63'>";
	$view_news .= "<div style='background-color:#e56d63'><h3 style='background-color:#e56d63'><center>" . $MSG_NEWS ."</center><h3></div>";
	$view_news .= "<div class='panel-body' style='background-color:#e56d63'>";
...
if ( !$result ) {
	...
	foreach ( $result as $row ) {
		...
		$view_news .= "<div class='panel-heading' style='background-color:#e56d63'><big>" . $row[ 'title' ] . "</big>-<small>" . $row[ 'user_id' ] . "</small></div>";
		$view_news .= "<div class='panel-body' style='background-color:#e56d63'>" . $row[ 'content' ] . "</div>";
		$view_news .= "</div>";
	}
	
}
$view_news .= "</div>";
$view_news .= "<div class='panel-footer' style='background-color:#e56d63'></div>";
$view_news .= "</div>";
